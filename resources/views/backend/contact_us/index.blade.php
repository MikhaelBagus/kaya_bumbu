        ...
        <div class="panel">
            <div class="panel-heading">
                <div class="panel-title hidden-xs">
                    <span class="glyphicon glyphicon-tasks"></span>Contact Us List
                </div>
            </div>

            @if($create)
            <div class="panel-menu">
                <a href="{{route('contact_us.create')}}" class="btn btn-flat btn-success btn-sm">@lang('auth.index_create_link')</a>
            </div>
            @endif
            <table class="table table-striped table-bordered table-hover table-condensed" id="contact-us-table" width="100%">
                <thead>
                <tr>
                    <th>#</th>
...
<script>
    $(function () {
        ...
        let table = $('#contact-us-table').DataTable({
            ...
            ajax: {
                url: '{!! route('contact_us.ajax.data') !!}',
                dataType: 'json'
            },
            columns: [
