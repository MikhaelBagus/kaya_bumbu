        ...
        <div class="panel panel-visible">
            <div class="panel-heading">
                <div class="panel-title hidden-xs">
                    <span class="glyphicon glyphicon-tasks"></span>Customer Create Form
                </div>
            </div>
                ...
                <div class="panel-body">
                    ...
                    <div class="col-md-12">
                        <div class="form-group @if($errors->has('phone')) has-error @endif">
                            ...
                            <input type="number" name="phone" id="phone" value="{{old('phone')}}" class="form-control input-sm" placeholder="Phone ...*" required>
