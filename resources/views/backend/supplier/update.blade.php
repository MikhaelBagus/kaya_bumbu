        ...
        <div class="panel panel-visible">
            <div class="panel-heading">
                <div class="panel-title hidden-xs">
                    <span class="glyphicon glyphicon-tasks"></span>Supplier Update Form
                </div>
            </div>

            <form action="{{route('supplier.update', [request()->id])}}" method="post">
                <div class="panel-body">
                    ...
                    <div class="col-md-12">
                        <div class="form-group @if($errors->has('supplier_name')) has-error @endif">
                            ...
                            <input type="text" name="supplier_name" id="supplier_name" value="{{old('supplier_name', $supplier->supplier_name)}}" class="form-control input-sm" placeholder="Supplier Name ...*" required>
                    ...
                    <div class="col-md-12">
                        <div class="form-group @if($errors->has('supplier_phone')) has-error @endif">
                            ...
                            <input type="number" name="supplier_phone" id="supplier_phone" value="{{old('supplier_phone', $supplier->supplier_phone)}}" class="form-control input-sm" placeholder="Supplier Phone ...*" required>
                    ...
                    <div class="col-md-12">
                        <div class="form-group @if($errors->has('supplier_description')) has-error @endif">
                            ...
                            <textarea name="supplier_description" id="supplier_description" class="form-control input-sm" placeholder="Supplier Description ..." rows="3">{{old('supplier_description', $supplier->supplier_description)}}</textarea>
