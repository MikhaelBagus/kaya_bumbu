                ...
                <div class="panel-body">
                    ...
                    <div class="col-md-12">
                        <div class="form-group @if($errors->has('supplier_phone')) has-error @endif">
                            ...
                            <input type="number" name="supplier_phone" id="supplier_phone" value="{{old('supplier_phone', $supplier->supplier_phone)}}" class="form-control input-sm" placeholder="Supplier Phone ...">
