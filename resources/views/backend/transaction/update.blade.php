...
@section('content')
    <section id="content" class="animated fadeIn">
        ...
        <div class="panel panel-visible">
            ...
            <form action="{{route('transaction.update', [request()->id])}}" method="post">
                        ...
                        <div class="col-md-6">
                            <div class="form-group @if($errors->has('transaction_type')) has-error @endif">
                                ...
                                <select id="transaction_type" name="transaction_type" class="form-control" data-placeholder="Pilih Tipe Transaksi" required>
                                    <option value=""></option>
                                    <option value="PO" @if($transaction->transaction_type == 'PO') selected @endif>PO</option>
                                    <option value="Pesanan Baru" @if($transaction->transaction_type == 'Pesanan Baru') selected @endif>Pesanan Baru</option>
                                </select>
                    ...
                    <div class="col-md-12">
                        <div class="col-md-6">
                            <div class="form-group @if($errors->has('date')) has-error @endif">
                                ...
                                <input type="text" name="date" id="date" value="{{old('date', $transaction->date)}}" class="form-control input-sm" placeholder="Tanggal Pengiriman ...*" readonly required>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-6">
                            <div class="form-group @if($errors->has('customer_name')) has-error @endif">
                                ...
                                <input type="text" name="customer_name" id="customer_name" value="{{old('customer_name', $transaction->customer_name)}}" class="form-control input-sm" placeholder="Nama Pemesan ...*" required>
                    ...
                    <div class="col-md-12">
                        <div class="col-md-6">
                            <div class="form-group @if($errors->has('recipient_phone')) has-error @endif">
                                ...
                                <input type="number" name="recipient_phone" id="recipient_phone" value="{{old('recipient_phone', $transaction->recipient_phone)}}" class="form-control input-sm" placeholder="Phone Penerima...*" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group @if($errors->has('recipient_name')) has-error @endif">
                                ...
                                <input type="text" name="recipient_name" id="recipient_name" value="{{old('recipient_name', $transaction->recipient_name)}}" class="form-control input-sm" placeholder="Nama Penerima ...*" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group @if($errors->has('province_id')) has-error @endif">
                                ...
                                <select id="province_id" name="province_id" class="form-control" data-placeholder="Pilih Provinsi Penerima" required>
                                    <option value="{{$transaction->city->province_id}}" selected>{{$transaction->city->province->name}}</option>
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="form-group @if($errors->has('city_id')) has-error @endif">
                                ...
                                <select id="city_id" name="city_id" class="form-control" data-placeholder="Pilih Kota Penerima" required>
                                    <option value="{{$transaction->city_id}}" selected>{{$transaction->city->name}}</option>
                                </select>
                    ...
                    <div class="col-md-12">
                        <div class="col-md-12">
                            <div class="form-group @if($errors->has('address')) has-error @endif">
                                ...
                                <textarea name="address" id="address" class="form-control input-sm" placeholder="Alamat Penerima ...*" required>{{old('address', $transaction->address)}}</textarea>
                        ...
                        <div class="col-md-6">
                            <div class="form-group @if($errors->has('source_id')) has-error @endif">
                                ...
                                <select id="source_id" name="source_id" class="form-control" data-placeholder="Pilih Sumber" required>
                                    <option value="{{$transaction->source_id}}" selected>{{$transaction->source->name}}</option>
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="form-group @if($errors->has('delivery_option')) has-error @endif">
                                ...
                                <select id="delivery_option" name="delivery_option" class="form-control" data-placeholder="Pilih Pengiriman Menggunakan" required>
                                    <option value=""></option>
                                    <option value="Via Kaya Bumbu" @if($transaction->delivery_option == 'Via Kaya Bumbu') selected @endif>Via Kaya Bumbu</option>
                                    <option value="Self Order" @if($transaction->delivery_option == 'Self Order') selected @endif>Self Order</option>
                                    <option value="Pick Up" @if($transaction->delivery_option == 'Pick Up') selected @endif>Pick Up</option>
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="form-group @if($errors->has('delivery_type')) has-error @endif">
                                ...
                                <select id="delivery_type" name="delivery_type" class="form-control" data-placeholder="Pilih Jenis Pengiriman" required>
                                    <option value=""></option>
                                    <option value="-" @if($transaction->delivery_type == '-') selected @endif>-</option>
                                    <option value="Instant" @if($transaction->delivery_type == 'Instant') selected @endif>Instant</option>
                                    <option value="Same Day" @if($transaction->delivery_type == 'Same Day') selected @endif>Same Day</option>
                                </select>
                    ...
                    <div class="col-md-12">
                        <div class="col-md-12">
                            <div class="form-group @if($errors->has('notes')) has-error @endif">
                                ...
                                <textarea name="notes" id="notes" class="form-control input-sm" placeholder="Notes ...">{{old('notes', $transaction->notes)}}</textarea>
