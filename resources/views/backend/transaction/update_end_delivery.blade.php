...
@section('content')
    <section id="content" class="animated fadeIn">
        ...
        <div class="panel panel-visible">
            ...
            <form action="{{route('transaction.update_end_delivery', [request()->id])}}" method="post" enctype="multipart/form-data">
                <div class="panel-body">
                    ...
                    <div class="col-md-12">
                        <div class="form-group @if($errors->has('file')) has-error @endif">
                            <label for="file" class="control-label">Tanda Terima</label>
