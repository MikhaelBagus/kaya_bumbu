        ...
        <div class="panel panel-visible">
            <div class="panel-heading">
                <div class="panel-title hidden-xs">
                    <span class="glyphicon glyphicon-tasks"></span>Product Category Update Form
                </div>
            </div>

            <form action="{{route('product_category.update', [request()->id])}}" method="post">
                <div class="panel-body">
                    ...
                    <div class="col-md-12">
                        <div class="form-group @if($errors->has('name')) has-error @endif">
                            ...
                            <input type="text" name="name" id="name" value="{{old('name', $product_category->name)}}" class="form-control input-sm" placeholder="Name ...*" required>
