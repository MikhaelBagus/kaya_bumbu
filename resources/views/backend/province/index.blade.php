        ...
        <div class="panel">
            <div class="panel-heading">
                <div class="panel-title hidden-xs">
                    <span class="glyphicon glyphicon-tasks"></span>Province List
                </div>
            </div>

            <div class="panel-menu">
                <a href="{{route('province.create')}}" class="btn btn-flat btn-success btn-sm">@lang('auth.index_create_link')</a>
            </div>
            <table class="table table-striped table-bordered table-hover table-condensed" id="province-table" width="100%">
                <thead>
                <tr>
                    <th>#</th>
...
<script>
    $(function () {
        ...
        let table = $('#province-table').DataTable({
            aaSorting: [[0, 'desc']],
            iDisplayLength: 25,
            //stateSave: true,
            // responsive: true,
