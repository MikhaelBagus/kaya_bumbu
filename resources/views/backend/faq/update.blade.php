        ...
        <div class="panel panel-visible">
            <div class="panel-heading">
                <div class="panel-title hidden-xs">
                    <span class="glyphicon glyphicon-tasks"></span>Faq Update Form
                </div>
            </div>

            <form action="{{route('faq.update', [request()->id])}}" method="post">
                <div class="panel-body">
                    ...
                    <div class="col-md-12">
                        <div class="form-group @if($errors->has('question')) has-error @endif">
                            ...
                            <input type="text" name="question" id="question" value="{{old('question', $faq->question)}}" class="form-control input-sm" placeholder="Question ...*" required>
