        ...
        <div class="panel">
            <div class="panel-heading">
                <div class="panel-title hidden-xs">
                    <span class="glyphicon glyphicon-tasks"></span>Disclaimer List
                </div>
            </div>

            @if($create)
            <div class="panel-menu">
                <a href="{{route('disclaimer.create')}}" class="btn btn-flat btn-success btn-sm">@lang('auth.index_create_link')</a>
            </div>
            @endif
            <table class="table table-striped table-bordered table-hover table-condensed" id="disclaimer-table" width="100%">
                <thead>
                <tr>
                    <th>#</th>
...
<script>
    $(function () {
        ...
        let table = $('#disclaimer-table').DataTable({
            aaSorting: [[0, 'desc']],
            iDisplayLength: 25,
            //stateSave: true,
            // responsive: true,
            ...
            ajax: {
                url: '{!! route('disclaimer.ajax.data') !!}',
                dataType: 'json'
            },
            columns: [
