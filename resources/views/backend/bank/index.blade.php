        ...
        <div class="panel">
            <div class="panel-heading">
                <div class="panel-title hidden-xs">
                    <span class="glyphicon glyphicon-tasks"></span>Bank List
                </div>
            </div>

            <div class="panel-menu">
                <a href="{{route('bank.create')}}" class="btn btn-flat btn-success btn-sm">@lang('auth.index_create_link')</a>
            </div>
            <table class="table table-striped table-bordered table-hover table-condensed" id="bank-table" width="100%">
                <thead>
                <tr>
                    <th>#</th>
