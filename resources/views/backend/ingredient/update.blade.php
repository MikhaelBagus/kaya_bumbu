        ...
        <div class="panel panel-visible">
            <div class="panel-heading">
                <div class="panel-title hidden-xs">
                    <span class="glyphicon glyphicon-tasks"></span>Ingredient Update Form
                </div>
            </div>
                ...
                <div class="panel-body">
                    ...
                    <div class="col-md-12">
                        <div class="form-group @if($errors->has('ingredient_master_category_id')) has-error @endif">
                            <label for="ingredient_master_category_id" class="control-label">BOM Sub-Category <span style="color: red">*</span></label>
                            <select id="ingredient_master_category_id" name="ingredient_master_category_id" class="form-control" data-placeholder="Select BOM Sub-Category" required>
                    ...
                    <div class="col-md-12">
                        <div class="form-group @if($errors->has('name')) has-error @endif">
                            ...
                            <input type="text" name="name" id="name" value="{{old('name', $ingredient->name)}}" class="form-control input-sm" placeholder="Ingredient Name ...*" required>
                    ...
                    <div class="col-md-12">
                        <div class="form-group @if($errors->has('unit')) has-error @endif">
                            ...
                            <input type="text" name="unit" id="unit" value="{{old('unit', $ingredient->unit)}}" class="form-control input-sm" placeholder="Unit (e.g., kg, gram, liter) ...*" required>
                    ...
                    <div class="col-md-12">
                        <div class="form-group @if($errors->has('price')) has-error @endif">
                            ...
                            <input type="number" name="price" id="price" value="{{old('price', $ingredient->price)}}" class="form-control input-sm" placeholder="Price ...*" required>
