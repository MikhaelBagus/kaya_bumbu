        ...
        <div class="panel panel-visible">
            <div class="panel-heading">
                <div class="panel-title hidden-xs">
                    <span class="glyphicon glyphicon-tasks"></span>City Update Form
                </div>
            </div>

            <form action="{{route('city.update', [request()->id])}}" method="post">
                <div class="panel-body">
                    ...
                    <div class="col-md-12">
                        <div class="form-group @if($errors->has('province_id')) has-error @endif">
                            ...
                            <select id="province_id" class="form-control" data-placeholder="Select Province" required>
                                <option value="{{$city->province_id}}">{{$city->province->name}}</option>
                            </select>
                    ...
                    <div class="col-md-12">
                        <div class="form-group @if($errors->has('name')) has-error @endif">
                            ...
                            <input type="text" name="name" id="name" value="{{old('name', $city->name)}}" class="form-control input-sm" placeholder="Name ...*" required>
