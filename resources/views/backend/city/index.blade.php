        ...
        <div class="panel">
            <div class="panel-heading">
                <div class="panel-title hidden-xs">
                    <span class="glyphicon glyphicon-tasks"></span>City List
                </div>
            </div>
            ...
            <table class="table table-striped table-bordered table-hover table-condensed" id="city-table" width="100%">
                <thead>
                <tr>
                    <th>#</th>
...
<script>
    $(function () {
        ...
        let table = $('#city-table').DataTable({
            aaSorting: [[0, 'desc']],
            aLengthMenu: [
