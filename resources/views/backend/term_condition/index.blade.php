        ...
        <div class="panel">
            <div class="panel-heading">
                <div class="panel-title hidden-xs">
                    <span class="glyphicon glyphicon-tasks"></span>Term Condition List
                </div>
            </div>

            @if($create)
            <div class="panel-menu">
                <a href="{{route('term_condition.create')}}" class="btn btn-flat btn-success btn-sm">@lang('auth.index_create_link')</a>
            </div>
            @endif
            <table class="table table-striped table-bordered table-hover table-condensed" id="term-condition-table" width="100%">
                <thead>
                <tr>
                    <th>#</th>
...
<script>
    $(function () {
        ...
        let table = $('#term-condition-table').DataTable({
            aaSorting: [[0, 'desc']],
            iDisplayLength: 25,
            //stateSave: true,
            // responsive: true,
            ...
            ajax: {
                url: '{!! route('term_condition.ajax.data') !!}',
                dataType: 'json'
            },
            columns: [
