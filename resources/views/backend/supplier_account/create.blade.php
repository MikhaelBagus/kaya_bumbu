        ...
        <div class="panel panel-visible">
            <div class="panel-heading">
                <div class="panel-title hidden-xs">
                    <span class="glyphicon glyphicon-tasks"></span>Supplier Account Create Form
                </div>
            </div>

            <form action="{{route('supplier_account.store')}}" method="post">
                <div class="panel-body">
                    ...
                    <div class="col-md-6">
                        <div class="form-group @if($errors->has('account_number')) has-error @endif">
                            ...
                            <input type="text" name="account_number" id="account_number" value="{{old('account_number')}}" class="form-control input-sm" placeholder="Account Number ...*" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group @if($errors->has('account_name')) has-error @endif">
                            ...
                            <input type="text" name="account_name" id="account_name" value="{{old('account_name')}}" class="form-control input-sm" placeholder="Account Name ...*" required>
                    ...
                    <div class="col-md-12">
                        <div class="form-group @if($errors->has('bank_name')) has-error @endif">
                            ...
                            <input type="text" name="bank_name" id="bank_name" value="{{old('bank_name')}}" class="form-control input-sm" placeholder="Bank Name ...*" required>
                    ...
                    <div class="col-md-12">
                        <div class="form-group @if($errors->has('description')) has-error @endif">
                            ...
                            <textarea name="description" id="description" class="form-control input-sm" placeholder="Description ..." rows="3">{{old('description')}}</textarea>
