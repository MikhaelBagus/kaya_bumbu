        ...
        <div class="panel">
            <div class="panel-heading">
                <div class="panel-title hidden-xs">
                    <span class="glyphicon glyphicon-tasks"></span>Supplier Account List
                </div>
            </div>

            <div class="panel-menu">
                <a href="{{route('supplier_account.create')}}" class="btn btn-flat btn-success btn-sm">@lang('auth.index_create_link')</a>
            </div>
            <table class="table table-striped table-bordered table-hover table-condensed" id="supplier_account-table" width="100%">
                <thead>
                <tr>
                    <th>#</th>
...
<script>
    $(function () {
        ...
        let table = $('#supplier_account-table').DataTable({
            aaSorting: [[0, 'desc']],
            aLengthMenu: [
            ...
            ajax: {
                url: '{!! route('supplier_account.ajax.data') !!}',
                dataType: 'json'
            },
            columns: [
                ...
                {data: 'supplier_name', name: 'supplier.supplier_name'},
