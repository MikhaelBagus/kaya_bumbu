        ...
        <div class="panel">
            <div class="panel-heading">
                <div class="panel-title hidden-xs">
                    <span class="glyphicon glyphicon-tasks"></span>Payment Method List
                </div>
            </div>

            <div class="panel-menu">
                <a href="{{route('payment_method.create')}}" class="btn btn-flat btn-success btn-sm">@lang('auth.index_create_link')</a>
            </div>
            <table class="table table-striped table-bordered table-hover table-condensed" id="payment_method-table" width="100%">
                <thead>
                <tr>
                    <th>#</th>
...
<script>
    $(function () {
        ...
        let table = $('#payment_method-table').DataTable({
            aaSorting: [[0, 'desc']],
            aLengthMenu: [
            ...
            ajax: {
                url: '{!! route('payment_method.ajax.data') !!}',
                dataType: 'json'
            },
            columns: [
