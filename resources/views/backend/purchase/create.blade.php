        ...
        <div class="panel panel-visible">
            <div class="panel-heading">
                <div class="panel-title hidden-xs">
                    <span class="glyphicon glyphicon-shopping-cart"></span>Purchase Create Form
                </div>
            </div>
            ...
            <form action="{{route('purchase.store')}}" method="post" id="purchase-form">
                <div class="panel-body">
                    {!! csrf_field() !!}
                    <input type="hidden" name="status" id="form-status" value="submitted">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group @if($errors->has('purchase_date')) has-error @endif">
                                ...
                                <input type="date" name="purchase_date" id="purchase_date" value="{{old('purchase_date', date('Y-m-d'))}}" class="form-control input-sm" required>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group @if($errors->has('supplier_account_id')) has-error @endif">
                                ...
                                <select name="supplier_account_id" id="supplier_account_id" class="form-control select2" disabled required>
                    ...
                    <div id="fullpayment-section" style="display: none;">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group @if($errors->has('full_payment_date')) has-error @endif">
                                    ...
                                    <input type="date" name="full_payment_date" id="full_payment_date" value="{{old('full_payment_date')}}" class="form-control input-sm">
                    ...
                    <div id="instalment-section" style="display: none;">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group @if($errors->has('down_payment')) has-error @endif">
                                    ...
                                    <input type="number" name="down_payment" id="down_payment" value="{{old('down_payment', 0)}}" class="form-control input-sm" step="1" min="0" placeholder="0">
                            ...
                            <div class="col-md-6">
                                <div class="form-group @if($errors->has('down_payment_date')) has-error @endif">
                                    ...
                                    <input type="date" name="down_payment_date" id="down_payment_date" value="{{old('down_payment_date')}}" class="form-control input-sm">
                    ...
                    <div class="row" style="margin-top: 20px;">
                        <div class="col-md-6">
                            ...
                            <div class="form-group @if($errors->has('notes')) has-error @endif">
                                ...
                                <textarea name="notes" id="notes" class="form-control input-sm" placeholder="Add transaction notes" rows="5">{{old('notes')}}</textarea>
        ...
        function addProductRow() {
            ...
            let row = `
                <tr data-index="${productRowIndex}">
                    <td>
                        <input type="hidden" name="items[${productRowIndex}][product_id]" class="product-id-${productRowIndex}">
                    ...
                    <td>
                        <input type="hidden" name="items[${productRowIndex}][warehouse_id]" class="warehouse-id-${productRowIndex}">
                    ...
                    <td>
                        <input type="hidden" name="items[${productRowIndex}][unit]" class="product-unit-value-${productRowIndex}">
                    ...
                    <td>
                        ...
                        <input type="number" class="form-control input-sm product-last-price product-last-price-${productRowIndex}" placeholder="0" step="1" value="0" readonly disabled style="background-color: #f4f4f4;">
                    </td>
                    <td>
                        <input type="number" name="items[${productRowIndex}][price]" class="form-control input-sm product-price product-price-${productRowIndex}" placeholder="0" step="1" value="0" required onchange="calculateTotals()">
                    </td>
        ...
        function addCostRow() {
            ...
            let row = `
                <tr data-index="${costRowIndex}">
                    <td>
                        <input type="text" name="costs[${costRowIndex}][cost_name]" class="form-control input-sm cost-name" placeholder="Cost name" required>
                    </td>
                    <td>
                        <input type="number" name="costs[${costRowIndex}][amount]" class="form-control input-sm cost-amount" placeholder="0" step="1" value="0" required onchange="calculateTotals()">
                    </td>
                    <td>
                        <input type="text" name="costs[${costRowIndex}][notes]" class="form-control input-sm cost-notes" placeholder="Notes">
                    </td>
                    <td class="text-center">
        ...
        function addDiscountRow() {
            ...
            let row = `
                <tr data-index="${discountRowIndex}">
                    <td>
                        <input type="text" name="discounts[${discountRowIndex}][discount_name]" class="form-control input-sm discount-name" placeholder="Discount name" required>
                    </td>
                    <td>
                        <input type="number" name="discounts[${discountRowIndex}][amount]" class="form-control input-sm discount-amount" placeholder="0" step="1" value="0" required onchange="calculateTotals()">
                    </td>
                    <td>
                        <input type="text" name="discounts[${discountRowIndex}][notes]" class="form-control input-sm discount-notes" placeholder="Notes">
                    </td>
                    <td class="text-center">
            ...
            for (let i = 1; i <= instalmentCount; i++) {
                ...
                let row = `
                    <tr>
                        ...
                        <td>
                            <input type="date" name="instalments[${i}][due_date]" class="form-control input-sm" value="${dueDate}">
                        </td>
                        <td>
                            <input type="number" name="instalments[${i}][amount]" class="form-control input-sm instalment-amount" step="1" value="${amount}" min="0">
                        </td>
                        <td>
                            <input type="date" name="instalments[${i}][paid_date]" class="form-control input-sm" value="${paymentDate}" style="background-color: #f4f4f4;">
                        </td>
                    </tr>
                `;
