        ...
        <div class="panel panel-visible">
            <div class="panel-heading">
                <div class="panel-title hidden-xs">
                    <span class="glyphicon glyphicon-tasks"></span>News Update Form
                </div>
            </div>

            <form action="{{route('news.update', [request()->id])}}" method="post" enctype="multipart/form-data">
                <div class="panel-body">
                    ...
                    <div class="col-md-12">
                        <div class="form-group @if($errors->has('title')) has-error @endif">
                            ...
                            <input type="text" name="title" id="title" value="{{old('title', $news->title)}}" class="form-control input-sm" placeholder="Title ...*" required>
                    ...
                    <div class="col-md-12">
                        <div class="form-group @if($errors->has('content')) has-error @endif">
                            ...
                            <textarea id="summernote" name="content" class="form-control input-sm" placeholder="Content ...*">{!! old('content', $news->content) !!}</textarea>
                    ...
                    <div class="col-md-12">
                        <div class="form-group @if($errors->has('publish')) has-error @endif">
                            ...
                            <select name="publish" id="publish" class="form-control input-sm select_2" style="width: 100%;" data-placeholder="Select..*" required>
                                <option></option>
                                <option value="1" @if($news->publish == 1) selected @endif>Yes</option>
                                <option value="0" @if($news->publish == 0) selected @endif>No</option>
                            </select>
                                        ...
                                        <div class="d-flex">
                                            <div class="flex-shrink-0 mr-7">
                                                <div class="symbol symbol-50 symbol-lg-120">
                                                    <img id="preview_image" src="{{$news->image}}"/>
                                                </div>
                                            </div>
                                        </div>
