    ...
    <section id="content" class="animated fadeIn">
        ...
        <div class="panel">
            ...
            <div class="panel-menu">
                <a href="{{route('ingredient_group.create')}}" class="btn btn-flat btn-success btn-sm">@lang('auth.index_create_link')</a>
            </div>
            <table class="table table-striped table-bordered table-hover table-condensed" id="ingredient_group-table" width="100%">
                <thead>
                <tr>
                    <th>#</th>
...
<script>
    $(function () {
        ...
        let table = $('#ingredient_group-table').DataTable({
            aaSorting: [[0, 'desc']],
            aLengthMenu: [
            ...
            ajax: {
                url: '{!! route('ingredient_group.ajax.data') !!}',
                dataType: 'json'
            },
            columns: [
