...
@section('content')
    <section id="content" class="animated fadeIn">
        ...
        <div class="panel panel-visible">
            ...
            <form action="{{route('expenditure_type.update', [request()->id])}}" method="post">
                <div class="panel-body">
                    ...
                    <div class="col-md-12">
                        <div class="form-group @if($errors->has('name')) has-error @endif">
                            ...
                            <input type="text" name="name" id="name" value="{{old('name', $expenditure_type->name)}}" class="form-control input-sm" placeholder="Name ...*" required>
