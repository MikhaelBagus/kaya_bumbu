        ...
        <div class="panel">
            <div class="panel-heading">
                <div class="panel-title hidden-xs">
                    <span class="glyphicon glyphicon-tasks"></span>Expenditure Type List
                </div>
            </div>

            <div class="panel-menu">
                <a href="{{route('expenditure_type.create')}}" class="btn btn-flat btn-success btn-sm">@lang('auth.index_create_link')</a>
            </div>
            <table class="table table-striped table-bordered table-hover table-condensed" id="expenditure_type-table" width="100%">
                <thead>
                <tr>
                    <th>#</th>
...
<script>
    $(function () {
        ...
        let table = $('#expenditure_type-table').DataTable({
            aaSorting: [[0, 'desc']],
            aLengthMenu: [
            ...
            ajax: {
                url: '{!! route('expenditure_type.ajax.data') !!}',
                dataType: 'json'
            },
            columns: [
