        ...
        <div class="panel panel-visible">
            <div class="panel-heading">
                <div class="panel-title hidden-xs">
                    <span class="glyphicon glyphicon-tasks"></span>Warehouse Create Form
                </div>
            </div>
                ...
                <div class="panel-body">
                    ...
                    <div class="col-md-12">
                        <div class="form-group @if($errors->has('warehouse_name')) has-error @endif">
                            ...
                            <input type="text" name="warehouse_name" id="warehouse_name" value="{{old('warehouse_name')}}" class="form-control input-sm" placeholder="Warehouse Name ...*" required>
                    ...
                    <div class="col-md-12">
                        <div class="form-group @if($errors->has('warehouse_description')) has-error @endif">
                            ...
                            <textarea name="warehouse_description" id="warehouse_description" class="form-control input-sm" placeholder="Warehouse Description ..." rows="3">{{old('warehouse_description')}}</textarea>
