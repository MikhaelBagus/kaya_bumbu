        ...
        <div class="panel">
            <div class="panel-heading">
                <div class="panel-title hidden-xs">
                    <span class="glyphicon glyphicon-tasks"></span>Privacy Policy List
                </div>
            </div>

            @if($create)
            <div class="panel-menu">
                <a href="{{route('privacy_policy.create')}}" class="btn btn-flat btn-success btn-sm">@lang('auth.index_create_link')</a>
            </div>
            @endif
            <table class="table table-striped table-bordered table-hover table-condensed" id="privacy-policy-table" width="100%">
                <thead>
                <tr>
                    <th>#</th>
...
<script>
    $(function () {
        ...
        let table = $('#privacy-policy-table').DataTable({
            aaSorting: [[0, 'desc']],
            iDisplayLength: 25,
            //stateSave: true,
            // responsive: true,
            ...
            ajax: {
                url: '{!! route('privacy_policy.ajax.data') !!}',
                dataType: 'json'
            },
            columns: [
