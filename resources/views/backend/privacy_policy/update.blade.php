        ...
        <div class="panel panel-visible">
            <div class="panel-heading">
                <div class="panel-title hidden-xs">
                    <span class="glyphicon glyphicon-tasks"></span>Privacy Policy Update Form
                </div>
            </div>

            <form action="{{route('privacy_policy.update', [request()->id])}}" method="post">
                <div class="panel-body">
                    ...
                    <div class="col-md-12">
                        <div class="form-group @if($errors->has('content')) has-error @endif">
                            ...
                            <textarea id="summernote" name="content" class="form-control input-sm" placeholder="Content ...*">{!! old('content', $privacy_policy->content) !!}</textarea>
