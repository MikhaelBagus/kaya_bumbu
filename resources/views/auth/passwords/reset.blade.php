    ...
    <section id="content" class="animated fadeIn">
        <div class="admin-form theme-info mw500" style="margin-top: 10%;" id="login">
            ...
            <div class="panel panel-info heading-border br-n">
                <form class="form-horizontal" method="POST" action="{{ route('auth.reset.password', [request('userId'), request('code')]) }}">
                    {{ csrf_field() }}
                    ...
                    <div class="panel-footer clearfix p10 ph15">
                        <button type="submit" class="button btn-primary mr10 pull-right">@lang('auth.reset_password_submit_btn')</button>
                    </div>
                </form>
            </div>
        </div>
