                     ...
                     <div class="col-md-6">
                        <div class="form-group @if($errors->has('name')) has-error @endif">
                         ...
                         <div class="form-group @if($errors->has('email')) has-error @endif">
                             ...
                             <input type="email" name="email" class="form-control input-sm" placeholder="user@risetproduk.com" value="{{ old('email') ?? $data->email }}" tabindex="3" required>
                    ...
                    <div class="col-md-12" id="userPenilaiPublik">
                        ...
                        <div class="col-md-6">
                            <div class="form-group @if($errors->has('no_mappi')) has-error @endif">
                                ...
                                <textarea name="no_mappi" id="no_mappi" class="form-control input-sm" placeholder="No MAPPI ...*">{{old('no_mappi', $data->no_mappi)}}</textarea>
                        ...
                        <div class="col-md-6">
                            <div class="form-group @if($errors->has('no_izin_penilai_publik')) has-error @endif">
                                ...
                                <textarea name="no_izin_penilai_publik" id="no_izin_penilai_publik" class="form-control input-sm" placeholder="No Izin Penilai Publik ...*">{{old('no_izin_penilai_publik', $data->no_izin_penilai_publik)}}</textarea>
                        ...
                        <div class="col-md-6">
                            <div class="form-group @if($errors->has('no_izin_bpn')) has-error @endif">
                                ...
                                <textarea name="no_izin_bpn" id="no_izin_bpn" class="form-control input-sm" placeholder="No Izin BPN ...*">{{old('no_izin_bpn', $data->no_izin_bpn)}}</textarea>
                        ...
                        <div class="col-md-6">
                            <div class="form-group @if($errors->has('no_register_penilai')) has-error @endif">
                                ...
                                <textarea name="no_register_penilai" id="no_register_penilai" class="form-control input-sm" placeholder="no_register_penilai ...*">{{old('no_register_penilai', $data->no_register_penilai)}}</textarea>
                        ...
                        <div class="col-md-6">
                            <div class="form-group @if($errors->has('description')) has-error @endif">
                                ...
                                <textarea name="description" id="description" class="form-control input-sm" placeholder="Description ...*">{{old('description', $data->description)}}</textarea>
                        ...
                        <div class="col-md-6">
                            <div class="form-group @if($errors->has('address')) has-error @endif">
                                ...
                                <textarea name="address" id="address" class="form-control input-sm" placeholder="Address ...*">{{old('address', $data->address)}}</textarea>
                        ...
                        <div class="col-md-6">
                            <div class="form-group @if($errors->has('city_id')) has-error @endif">
                                ...
                                <select name="city_id" id="city_id" class="form-control input-sm select_2" style="width: 100%;" data-placeholder="City..*">
                                    @if($data->user_city == null)
                                    @else
                                    <option value="{{$data->user_city->city->id}}" selected>{{$data->user_city->city->name}}</option>
                                    @endif
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="form-group @if($errors->has('price')) has-error @endif">
                                ...
                                <input type="number" name="price" id="price" value="{{old('price', $data->price)}}" class="form-control input-sm" placeholder="Price ...*" min="0">
                        ...
                        <div class="col-md-6">
                            <div class="form-group @if($errors->has('jenis_keahlian_id')) has-error @endif">
                                ...
                                <select name="jenis_keahlian_id[]" id="jenis_keahlian_id" class="form-control input-sm select_2" style="width: 100%;" data-placeholder="Jenis Keahlian..*" multiple>
                                    @foreach($data->keahlian_user as $keahlianUserEach)
                                    <option value="{{$keahlianUserEach->jenis_keahlian->id}}" selected>{{$keahlianUserEach->jenis_keahlian->name}}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="form-group @if($errors->has('kjpp_id')) has-error @endif">
                                ...
                                <select name="kjpp_id" id="kjpp_id" class="form-control input-sm select_2" style="width: 100%;" data-placeholder="KJPP..*">
                                    @if($data->kjpp_user == null)
                                    @else
                                    <option value="{{$data->kjpp_user->kjpp->id}}" selected>{{$data->kjpp_user->kjpp->name}}</option>
                                    @endif
                                </select>
                                            ...
                                            <div class="d-flex">
                                                <div class="flex-shrink-0 mr-7">
                                                    <div class="symbol symbol-50 symbol-lg-120">
                                                        <img id="preview_photo" src="{{$data->photo}}"/>
                                                    </div>
                                                </div>
                                            </div>
...
@push('scripts')
    ...
    <script type="text/javascript">
        $(function () {
            ...
            if(data['user_role']['role']['slug'] == 'penilai-publik' || data['user_role']['role']['slug'] == 'penilai-publik-admin'){
